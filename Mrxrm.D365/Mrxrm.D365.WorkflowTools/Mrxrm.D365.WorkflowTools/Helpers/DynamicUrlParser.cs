...
namespace Mrxrm.D365.WorkflowTools.Mrxrm.D365.WorkflowTools.Helpers
{
    /// <summary>
    /// Credit to Develop1.
    /// I also added extre methods to this class.
    /// </summary>
    public class DynamicUrlParser
    {
        ...
        {
            string entityName = GetEntityLogicalName(service);

            if (String.IsNullOrEmpty(entityName)) return null;

            return new EntityReference(entityName, this.Id);
        }
    }
}
