...
namespace Mrxrm.D365.WorkflowTools.Mrxrm.D365.WorkflowTools
{
    ...
    {
        public static void Distribute(this IDistributeWorkflowActivity activity, Guid workflowId, IOrganizationService orgService, ITracingService tracer)
        {
            var keys = activity.GetKeys(orgService);
